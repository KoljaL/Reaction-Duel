...
<body>
  ...
  <div id="joinForm" style="display: <?= $displayPlayer2 ?>">
  ...
  <div style="display: <?= $displayPlayer2 ?>">
      ...
      fetch('join_game.php', {
        ...
        .then(data => {
          if (data.success) {
            ...
            // Now that Player 2 has joined, add the event listener for the start button
